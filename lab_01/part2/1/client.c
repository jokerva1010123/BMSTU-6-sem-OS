...
{	
	...
	//тип SOCK_DGRAM -  определяют ненадежную  службу datagram без установления логического соединения, 
	//когда пакеты могут передаваться без сохранения логического порядка
