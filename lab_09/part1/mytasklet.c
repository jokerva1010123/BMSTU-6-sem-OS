...
//разрешить разделение (совместное использование) линии IRQ с другими устройствами (PCI шина и устройства).

// "name" - имя устройства, вызывающего прерывание (для справки), 
// my_handler - id девайса, нужно при удалении. Если большеn одного обработчика, то 
